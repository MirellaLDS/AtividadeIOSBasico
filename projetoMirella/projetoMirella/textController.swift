//
//  Day6TableViewController.swift
//  Day6_
//
//  Created by Marlon Chalegre on 08/01/19.
//  Copyright © 2019 CESAR School. All rights reserved.
//

import UIKit

class Day6TableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.myCellButton?.setTitle("\(indexPath.row)",for: UIControl.State.normal)
